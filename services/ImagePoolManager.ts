...
const imagePool: LevelImage[] = [
  ...
  },
  {
    ...
    strokeCount: 9,
    colors: ['#FFF3E0', '#D7A86E', '#E74C3C', '#B71C1C', '#FFFFFF', '#4CAF50', '#2E7D32', '#FFD700'],
    pack: 'natur-v1',
  },
  {
  ...
  },
  {
    ...
    strokeCount: 13,
    colors: ['#8D6E63', '#5D4037', '#81D4FA', '#0288D1', '#FFFFFF', '#B3E5FC', '#4CAF50', '#2E7D32', '#ECEFF1'],
    pack: 'natur-v1',
  },
  {
    ...
    strokeCount: 13,
    colors: ['#8D6E63', '#5D4037', '#E74C3C', '#B71C1C', '#FF7043', '#FFB74D', '#CFD8DC', '#2E7D32', '#4CAF50', '#ECEFF1'],
    pack: 'natur-v1',
  },
  ...
  // Märchen v1 – Themen-Pack (Difficulty 2–4)
  {
    ...
    displayNameEn: 'Crown',
    strokeCount: 9,
    colors: ['#FFD700', '#B8860B', '#E74C3C', '#B71C1C', '#3498DB', '#1565C0', '#9B59B6', '#FF69B4'],
    pack: 'maerchen-v1',
  },
  {
  ...
  },
  {
    ...
    displayNameEn: 'Fairy',
    strokeCount: 11,
    colors: ['#FF69B4', '#C2185B', '#FDBCB4', '#E8998D', '#9B59B6', '#6C3483', '#7C5CFF', '#4A2FBF', '#1A1A1A', '#8B5A2B', '#FFD700', '#87CEEB'],
    pack: 'maerchen-v1',
  },
  {
  ...
  },
  {
    ...
    strokeCount: 10,
    colors: ['#7C5CFF', '#4A2FBF', '#9B7BFF', '#E6DFFF', '#FFD700', '#B8860B', '#E74C3C', '#87CEEB'],
    pack: 'maerchen-v1',
  },
  {
    ...
    strokeCount: 13,
    colors: ['#FFFFFF', '#B0BEC5', '#FFD700', '#B8860B', '#FF69B4', '#C2185B', '#1A1A1A', '#9B59B6', '#6C3483', '#87CEEB'],
    pack: 'maerchen-v1',
  },
  {
  ...
  },
  {
    ...
    strokeCount: 13,
    colors: ['#D3D3D3', '#8A8A8A', '#7C5CFF', '#4A2FBF', '#5D4037', '#3E2723', '#87CEEB', '#FFD700', '#E74C3C', '#B71C1C', '#4CAF50', '#2E7D32'],
    pack: 'maerchen-v1',
  },
  ...
  },
  {
    ...
    strokeCount: 11,
    colors: ['#FF7043', '#E64A19', '#FFFFFF', '#D0D0D0', '#E74C3C', '#B71C1C', '#3498DB', '#FFD700', '#27AE60', '#FF69B4'],
    pack: 'essen-v1',
  },
  {
  ...
  },
  {
    ...
    strokeCount: 14,
    colors: ['#FF9EC4', '#C2185B', '#FFB6D9', '#FFFFFF', '#FFD700', '#3498DB', '#FF7043', '#27AE60', '#FF69B4'],
    pack: 'essen-v1',
  },
  {
    ...
    strokeCount: 13,
    colors: ['#E8B063', '#B8804A', '#FFFFFF', '#4CAF50', '#2E7D32', '#8B5A2B', '#5D3A1A', '#FFD700', '#D4A017', '#E74C3C', '#B71C1C', '#9B59B6', '#6C3483'],
    pack: 'essen-v1',
  },
  {
