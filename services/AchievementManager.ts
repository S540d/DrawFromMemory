...
export type AchievementId =
  'first_5_stars' | 'gallery_10' | 'streak_7' | 'all_levels_done' | 'daily_5' | 'all_difficulties';
...
export const ACHIEVEMENTS: AchievementDef[] = [
  {
    id: 'first_5_stars',
    emoji: '🌟',
    titleKey: 'achievements.first_5_stars.title',
    descKey: 'achievements.first_5_stars.desc',
  },
  {
    id: 'gallery_10',
    emoji: '🎨',
    titleKey: 'achievements.gallery_10.title',
    descKey: 'achievements.gallery_10.desc',
  },
  {
    id: 'streak_7',
    emoji: '🔥',
  ...
  },
  {
    id: 'all_levels_done',
    emoji: '🏆',
    titleKey: 'achievements.all_levels_done.title',
    descKey: 'achievements.all_levels_done.desc',
  },
  {
    id: 'daily_5',
    emoji: '🎯',
    titleKey: 'achievements.daily_5.title',
    descKey: 'achievements.daily_5.desc',
  },
  {
    id: 'all_difficulties',
    emoji: '🌈',
    titleKey: 'achievements.all_difficulties.title',
    descKey: 'achievements.all_difficulties.desc',
  },
];
